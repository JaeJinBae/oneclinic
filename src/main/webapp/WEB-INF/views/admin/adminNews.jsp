	...
	<div class="contentWrap">
		<div class="leftMenu">
			...
			<ul> 
				...
				<li> <a href="${pageContext.request.contextPath}/admin/adminNews" style="font-weight:bold;"> 언론보도</a></li>
		...
		<div class="centerMenu">
			...
			<div class="tbl_board">
					...
					<c:choose>
					    ...
					    <c:otherwise> 
					        <c:forEach var="item" items="${list}">
								<tr>
									<td>${item.no}</td>
									<td class="title"><a href="adminNewsRead${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title}</a></td>
									<td>${item.writer}</td>
									<td>${item.regdate}</td>
									<td>${item.cnt}</td>
									<td>
				...
				<p class="registerBtn"><a href="${pageContext.request.contextPath}/admin/adminNewsRegister${pageMaker.makeSearch(pageMaker.cri.page)}"><button>글쓰기</button></a></p>
				<div class="page">
					<ul>
