			...
			<div class="contentWrap">
					...
					<div class="content">
						...
						<div class="contentAside2">
							...
							<ul>
								<li><p>-</p><p>계명대학교 의과대학교 졸업 2005.</p></li>
								<li><p>-</p><p>가톨릭대학교 중앙의료원 인턴 수료</p> </li>
								<li><p>-</p><p>가톨릭대학교 중앙의료원 마취통증의학과 레지던트 수료</p></li>
								<li><p>-</p><p>마취통증의학과 전문의</p></li>
								<li><p>-</p><p>여의도 성모병원 마취통증의학과 임상강사</p></li>
								<li><p>-</p><p>통증의학 고위자 과정 이수</p></li>
							</ul>
							<ul>
								<li><p>-</p><p>올림픽병원 마취통증의학과 과장</p></li>
								<li><p>-</p><p>유성선병원 마취통증의학과 과장</p></li>
