			...
			<div class="contentWrap">
					...
					<div class="content">
						<div class="tblWrap">
									...
									<tr>
										...
										<td>
											<c:choose>
												...
												<c:otherwise>
													<a href="${pageContext.request.contextPath}/mMenu04_01Read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${beforeItem.no}">${beforeItem.title}</a>
												</c:otherwise>
											</c:choose>
										</td>
									</tr>
									<tr>
										...
										<td>
											<c:choose>
												...
												<c:otherwise>
													<a href="${pageContext.request.contextPath}/mMenu04_01Read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${afterItem.no}">${afterItem.title}</a>
												</c:otherwise>
											</c:choose>
										</td>
									</tr>
							...
							<p class="backBtn"><a href="${pageContext.request.contextPath}/mMenu04_01">목 록</a></p>
						</div><!-- tblWrap end -->
					</div><!-- content end -->
				</div><!-- contentWrap end -->
		</div><!-- sectionWrap end -->
