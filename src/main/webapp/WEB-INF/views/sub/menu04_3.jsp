...
.contentTitle > table tr > td:nth-child(3){
	background: #4f4f4f;
}
...
.contentTitle > table tr > td:nth-child(3) > a{
	color: #fff;
	font-weight: bold;
}
			...
			<div class="sectionContent">
				...
				<div class="contentWrap">
					<div class="contentTitle">
						<table>
							<tr>
								<td><a href="${pageContext.request.contextPath}/menu04_01">영양치료</a></td>
								<td><a href="${pageContext.request.contextPath}/menu04_02">성장</a></td>
								<td><a href="${pageContext.request.contextPath}/menu04_03">다이어트</a></td>
							</tr>
						</table>
					</div><!-- contentTitle end -->
					<div class="content">
						<img src="${pageContext.request.contextPath}/resources/images/menu04_3img.jpg">
					</div><!-- content end -->
				</div><!-- contentWrap end -->
