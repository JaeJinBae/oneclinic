	...
	<div class="allWrap">
		...
		<div class="sectionWrap">
			...
			<div class="sectionContent">
				...
				<div class="leftMenu">
					<div class="line"></div>
					<h2 style="margin-bottom: 20px;">06</h2>
					<h2>언론보도</h2>
					<div class="line"></div> 
					<ul>
				...
				<div class="contentWrap">
					...
					<div class="content">
						<div class="tblWrap">
									...
									<tr>
										...
										<td>
											<c:choose>
												...
												<c:otherwise>
													<a href="${pageContext.request.contextPath}/menu01_06Read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${beforeItem.no}">${beforeItem.title}</a>
												</c:otherwise>
											</c:choose>
										</td>
									</tr>
									<tr>
										...
										<td>
											<c:choose>
												...
												<c:otherwise>
													<a href="${pageContext.request.contextPath}/menu01_06Read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${afterItem.no}">${afterItem.title}</a>
												</c:otherwise>
											</c:choose>
										</td>
									</tr>
							...
							<p class="backBtn"><a href="${pageContext.request.contextPath}/menu01_06">목 록</a></p>
						</div><!-- tblWrap end -->
					</div><!-- content end -->
				</div><!-- contentWrap end -->
