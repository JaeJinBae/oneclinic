...
.contentTitle > table tr > td:nth-child(4){
	background: #4f4f4f;
}
.contentTitle > table tr > td > a{
	font-size: 14px;
}
.contentTitle > table tr > td:nth-child(4) > a{
	color: #fff;
	font-weight: bold;
}
.content{
	...
	<div class="allWrap">
		...
		<div class="sectionWrap">
			...
			<div class="contentWrap">
				...
				<div class="content">
					<img class="fix_img" src="${pageContext.request.contextPath}/resources/images/menu02_4img.jpg">
				</div><!-- content end -->
			</div><!-- contentWrap end -->
		</div><!-- sectionWrap end -->
